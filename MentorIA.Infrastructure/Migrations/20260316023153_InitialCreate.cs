        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialSummaries_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticeQuizzes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PracticeQuizzes_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PracticeQuizId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizQuestions_PracticeQuizzes_PracticeQuizId",
                        column: x => x.PracticeQuizId,
                        principalTable: "PracticeQuizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialSummaries_MaterialId",
                table: "MaterialSummaries",
                column: "MaterialId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PracticeQuizzes_MaterialId",
                table: "PracticeQuizzes",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizQuestions_PracticeQuizId",
                table: "QuizQuestions",
